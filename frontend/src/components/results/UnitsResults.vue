<template>
   ...
   >
      ...
      <template #paginatorstart>
         <DPGButton label="Download Results CSV" class="p-button-secondary download" @click="downloadCSV" v-if="searchStore.units.total>0" />
      ...
      <Column field="status" header="Status" class="nowrap" filterField="unit_status" :showFilterMatchModes="false" >
         <template #filter="{filterModel}">
            <Dropdown v-model="filterModel.value" :options="unitStatuses" optionLabel="name" optionValue="code" placeholder="Select a status" />
         </template>
         <template #body="slotProps">
